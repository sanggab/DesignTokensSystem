...
enum GabDesignModel {
    ...
    enum Popup {
        ...
        enum Sys {
            ...
            static var description: String { ColorLoader.shared.getString(named: "popup.sys.description") ?? "Use Amber for Messages, Video Calls, Direct Messages, and Boost." }
            ...
            enum Shadow {
                ...
                enum Primary {
                    ...
                    static var value: GabShadow { GabShadow(x: CGFloat(x), y: CGFloat(y), blur: CGFloat(blur), spread: CGFloat(spread), color: colorColor) }
                }

            }

            static var subtitle: String { ColorLoader.shared.getString(named: "popup.sys.subtitle") ?? "👉 Log in daily to get 6 Amber!" }

            static var title: String { ColorLoader.shared.getString(named: "popup.sys.title") ?? "🎁 Daily Bonus Amber" }
